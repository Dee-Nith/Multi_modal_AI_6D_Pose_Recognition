#!/usr/bin/env python3
"""
👁️ Continue Viewing from Image 25
=================================
Continue viewing images from 25 onwards individually.
"""
...
class ContinueViewingFrom25:
    """Continue viewing images from 25 onwards."""
    
    def __init__(self):
        """Initialize the viewer."""
        print("👁️ Initializing Continue Viewing from Image 25...")
        
        # Load YOLO model
        self.model = YOLO('../../coppelia_sim_results/weights/best.pt')
        self.camera_matrix = np.array([[800, 0, 320], [0, 800, 240], [0, 0, 1]])
        
        print("✅ Continue Viewing from Image 25 initialized!")
    ...
    def find_images_from_25(self):
        """Find all images from 25 onwards."""
        images = []
        for i in range(25, 100):  # Check up to 99
    ...
    def view_images_from_25(self):
        """View all images from 25 onwards individually."""
        print("🔍 Finding all images from 25 onwards...")
        
        all_image_ids = self.find_images_from_25()
        
        if not all_image_ids:
            print("❌ No images found from 25 onwards!")
            return
        ...
        print(f"\n🎉 Completed viewing {len(all_image_ids)} images from 25 onwards!")

def main():
    """Main function."""
    print("👁️ Continue Viewing from Image 25")
    print("=" * 40)
    
    # Initialize viewer
    viewer = ContinueViewingFrom25()
    
    # View images from 25 onwards
    viewer.view_images_from_25()
