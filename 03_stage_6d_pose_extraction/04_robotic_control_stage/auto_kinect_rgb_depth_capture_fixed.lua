-- Auto Kinect RGB + Depth Capture - Fixed Version
-- Captures both RGB and depth images from Kinect

print("Auto Kinect RGB + Depth Capture - Fixed Version")
print("================================================")
...
if kinectRGB ~= -1 and kinectDepth ~= -1 then
    ...
    function findNextNumber()
        ...
        -- Check for existing files in organized folders
        for i = 1, 100 do
            local filename = "../rgb_captures/auto_kinect_" .. i .. "_rgb.txt"
    ...
    function captureRGBImage(imageNumber)
        ...
        if rgbImage then
            ...
            -- Save RGB to organized folder
            local filename = "../rgb_captures/auto_kinect_" .. imageNumber .. "_rgb.txt"
    ...
    function captureDepthImage(imageNumber)
        ...
        if depthImage then
            ...
            local filename = "../depth_captures/auto_kinect_" .. imageNumber .. "_depth.txt"
    ...
    if success then
        ...
        print("Files created:")
        print("  - ../rgb_captures/auto_kinect_" .. nextNumber .. "_rgb.txt")
        print("  - ../depth_captures/auto_kinect_" .. nextNumber .. "_depth.txt")
