-- Auto Kinect RGB + Depth Capture - Simple Version
-- Captures both RGB and depth images from Kinect

print("Auto Kinect RGB + Depth Capture - Simple Version")
print("=================================================")
...
if kinectRGB ~= -1 and kinectDepth ~= -1 then
    ...
    function captureDepthImage(imageNumber)
        ...
        if depthImage then
            ...
            local filename = "auto_kinect_" .. imageNumber .. "_depth.txt"
